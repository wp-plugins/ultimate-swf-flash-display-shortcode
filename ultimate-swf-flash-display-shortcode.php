...
";
$data_display .= "<div class='copy' style='color:#ccc; font-size: 9px; '><a href='http://www.expressmedrefills.com/' title='Click here' target='_blank'>Visit The Website</a></div>";
}
 	return $data_display;
 }