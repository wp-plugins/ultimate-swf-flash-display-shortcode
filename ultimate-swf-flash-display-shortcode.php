...
";
$data_display .= "<div class='copy' style='color:#ccc; font-size: 9px; '><a href='http://crescentappraisal.com/' title='click here' target='_blank'>Estate Appraisal Seattle</a></div>";
}
 	return $data_display;
 }